...
namespace EgyptianMuseum.Application.Interfaces
{
    public interface IMapService
    {
        ...
        Task<List<MapResponseDto>> GetAllAsync(string lang, CancellationToken cancellationToken = default);
        Task<MapResponseDto?> GetByIdAsync(int id, CancellationToken cancellationToken = default);
        Task<MapResponseDto?> GetByIdAsync(int id, string lang, CancellationToken cancellationToken = default);
        Task<List<MapResponseDto>> GetByZoneAsync(string zone, CancellationToken cancellationToken = default);
        Task<List<MapResponseDto>> GetByZoneAsync(string zone, string lang, CancellationToken cancellationToken = default);
